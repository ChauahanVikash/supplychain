  ...
  <center>
    ...
    <div style="width: 100%">
      ...
      <div class="loginformcard" id="card1">
            <h4> Blockchain in Supply Chain</h4>
            <p style="max-width: 80%;">
             Bloackchain based Supply Chain Application. It stores the whereabouts of product at every transfer into the Blockchain. At consumer end, customers can  scan product's QR CODE and get information about the origin of that product hence empowering  consumers to only purchase authentic and quality products."
            </p>
