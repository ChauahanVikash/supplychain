...
<html lang="en">
  ...
  <?php }else{
    ...
    $("#aboutbtn").on("click", function(){
        showAlert("Bloackchain based Supply Chain Application. It stores the whereabouts of product at every transfer into the Blockchain. At consumer end, customers can  scan product's QR CODE and get information about the origin of that product hence empowering  consumers to only purchase authentic and quality products.");
    });
